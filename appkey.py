...
def login(email):
  ...
  if api_code in apikey:
    ...
    print(f'{Fore.LIGHTWHITE_EX}[+]{Fore.LIGHTRED_EX} Your Apikey Has Expired{Fore.LIGHTWHITE_EX} [+]')
    print(f'{Fore.LIGHTWHITE_EX}[+]{Fore.LIGHTGREEN_EX} Get premium Apikey to')
    print(f'{Fore.LIGHTWHITE_EX}[+]{Fore.LIGHTGREEN_EX}fb {Fore.LIGHTYELLOW_EX}@imamkun09{Fore.LIGHTGREEN_EX} or telegram {Fore.LIGHTYELLOW_EX}@hunterz_dice{Fore.LIGHTWHITE_EX} [+]')
    sys.exit(0)
